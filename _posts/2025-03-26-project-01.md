...
#### 15.商城首页面(使用thymeleaf)

<img src="../img/md-img/2025-03-26-project-01/截屏2025-04-05 10.31.26.png" alt="截屏2025-04-05 10.31.26" style="zoom:50%;" />

需求: 左边栏一级菜单显示,二级菜单显示, 三级菜单显示

<img src="../img/md-img/2025-03-26-project-01/截屏2025-04-05 10.42.25.png" alt="截屏2025-04-05 10.42.25" style="zoom:33%;" />
...
<img src="../img/md-img/2025-03-26-project-01/截屏2025-04-05 13.39.12.png" alt="截屏2025-04-05 13.39.12" style="zoom:50%;" />

#### 16.首页搜索

点击三级分类时进入搜索结果页面<img src="../img/md-img/2025-03-26-project-01/截屏2025-04-05 13.40.57.png" alt="截屏2025-04-05 13.40.57" style="zoom:50%;" />
...
处理分页, 因为不是vue的前后端分离,所以还是需要整个页面更新,不能使用局部ajax更新
...
现在配置nginx相关的: 反向代理, 域名解析和动静分离

配置SSH登录linux

配置nginx, 卷挂载配置文件和挂载目录
...
<img src="../img/md-img/2025-03-26-project-01/截屏2025-04-05 18.21.36.png" alt="截屏2025-04-05 18.21.36" style="zoom:50%;" />
...
把commdity微服务的static目录的css,img,js,font,等静态文件移动到nginx中
...
```shell
scp -r /Users/qingsongcai/IdeaProjects/j2025/jiaju_mall_v2/mall.commodity/src/main/resources/static root@192.168.2.85:/app/nginx_data/html
```

重启commdity服务,并清除浏览器缓存,再去访问www.jjmall.com, 发现静态资源都没有了

<img src="../img/md-img/2025-03-26-project-01/截屏2025-04-05 20.02.04.png" alt="截屏2025-04-05 20.02.04" style="zoom:50%;" />

nginx配置静态资源转发路径nginx的服务器文件目录
